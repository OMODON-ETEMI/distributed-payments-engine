...
type Querier interface {
	...
	GetAccountByID(ctx context.Context, dollar_1 pgtype.UUID) (Account, error)
	GetAccountByNumber(ctx context.Context, accountNumber string) (Account, error)
	GetActiveHoldsForAccount(ctx context.Context, dollar_1 pgtype.UUID) ([]FundsHold, error)
	...
	GetBalancesForAccount(ctx context.Context, dollar_1 pgtype.UUID) ([]GetBalancesForAccountRow, error)
	GetCustomerByExternalRef(ctx context.Context, externalRef string) (Customer, error)
	GetCustomerByID(ctx context.Context, dollar_1 pgtype.UUID) (Customer, error)
	GetJournalTransactionByRef(ctx context.Context, transactionRef string) (JournalTransaction, error)
	GetTransferRequestByID(ctx context.Context, dollar_1 pgtype.UUID) (TransferRequest, error)
	GetTransferRequestByIdempotencyKey(ctx context.Context, dollar_1 pgtype.UUID) (TransferRequest, error)
	ListAccountsByCustomer(ctx context.Context, arg ListAccountsByCustomerParams) ([]Account, error)
	ListCustomers(ctx context.Context, arg ListCustomersParams) ([]Customer, error)
	ListJournalLinesForTransaction(ctx context.Context, dollar_1 pgtype.UUID) ([]JournalLine, error)
	ListReconciliationItemsForBatch(ctx context.Context, dollar_1 pgtype.UUID) ([]ReconciliationItem, error)
	ListTransferRequestsByCustomer(ctx context.Context, arg ListTransferRequestsByCustomerParams) ([]TransferRequest, error)
	MarkJournalTransactionPosted(ctx context.Context, dollar_1 pgtype.UUID) (JournalTransaction, error)
